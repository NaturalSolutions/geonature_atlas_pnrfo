...
then
    ...
    export PGPASSWORD=$owner_atlas_pass;psql -d $db_name -U $owner_atlas -h $db_host -p 28900 -f /tmp/atlas.sql  &>> log/install_db.log
    sudo -n -u postgres -s psql -d $db_name -p 28900 -c "ALTER TABLE atlas.bib_altitudes OWNER TO "$owner_atlas";"
    sudo -n -u postgres -s psql -d $db_name -p 28900 -c "ALTER TABLE atlas.bib_taxref_rangs OWNER TO "$owner_atlas";"
    sudo -n -u postgres -s psql -d $db_name -p 28900 -c "ALTER TABLE atlas.bib_taxref_rangs OWNER TO "$owner_atlas";"
    sudo -n -u postgres -s psql -d $db_name -p 28900 -c "ALTER FUNCTION atlas.create_vm_altitudes() OWNER TO "$owner_atlas";"
    sudo -n -u postgres -s psql -d $db_name -p 28900 -c "ALTER FUNCTION atlas.find_all_taxons_childs(integer) OWNER TO "$owner_atlas";"
    ...
    sudo -n -u postgres -s psql -d $db_name -p 28900 -f data/observations_mailles.sql  &>> log/install_db.log
    sudo -n -u postgres -s psql -d $db_name -p 28900 -c "ALTER TABLE atlas.vm_observations_mailles OWNER TO "$owner_atlas";"
    ...
    sudo -n -u postgres -s psql -d $db_name -p 28900 -f /tmp/grant.sql &>> log/install_db.log
